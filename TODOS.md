...
- [ ] **Rename brainiac package to cortex**
  ...
  **Blocked by this:** When renamed, update all 5 new autonomy commands (/run-tasks, /ralph-start, /ralph-stop, /ralph-status, /auto-research) + ralph-loop.sh + quality-check.sh which reference `python -m brainiac`. 7+ references across new files.
